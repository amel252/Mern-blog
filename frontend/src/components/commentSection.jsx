...
//         try {
//             // si l'user n'est pas connécté on redirige pour se connecter
//             if (!currentUser) {
//                 navigate("/sign-in");
//                 return;
//             }
...
//         setComments(
//             comments.map((comm) => {
//                 comm._id === comment._id
//                     ? { ...comm, content: editedContent }
//                     : comm;
//             })
//         );
//     };
...
//                             type="submit"
//                             // revoir ca
//                             className="flex justify-between items-center mt-5 text-s"
//                         >
